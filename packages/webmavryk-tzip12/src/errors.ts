 ...
 */
export class TokenMetadataNotFound extends WebMavrykError {
 ...
 */
export class TokenIdNotFound extends WebMavrykError {
 ...
 */
export class InvalidTokenMetadata extends WebMavrykError {
