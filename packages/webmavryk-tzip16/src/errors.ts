...
import { ParameterValidationError, WebMavrykError, MavrykToolkitConfigError } from '@mavrykdynamics/webmavryk-core';

export { InvalidViewParameterError } from '@mavrykdynamics/webmavryk-core';

/**
 *  @category Error
 *  @description Error that indicates missing big map metadata (non compliance to the TZIP-16 standard)
 */
export class BigMapContractMetadataNotFoundError extends WebMavrykError {
 ...
 */
export class ContractMetadataNotFoundError extends WebMavrykError {
 ...
 */
export class UriNotFoundError extends WebMavrykError {
  constructor() {
    super();
 ...
 */
export class InvalidUriError extends WebMavrykError {
 ...
 */
export class InvalidContractMetadataError extends WebMavrykError {
 ...
 */
export class InvalidContractMetadataTypeError extends WebMavrykError {
  constructor() {
    super();
 ...
 */
export class ForbiddenInstructionInViewCodeError extends WebMavrykError {
