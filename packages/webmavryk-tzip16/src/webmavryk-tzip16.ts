 ...
 * @module @mavrykdynamics/webmavryk-tzip16
 */
...
/**
 * @deprecated `import { bytesToString, stringToBytes } from "@mavrykdynamics/webmavryk-tzip16"` is deprecated in favor of
 * `import { bytesToString, stringToBytes } from "@mavrykdynamics/webmavryk-utils"`
 *
 */
export { bytesToString, stringToBytes } from '@mavrykdynamics/webmavryk-utils';
