  ...
  describe('SaplingStateAbstraction getSaplingDiff method', () => {
    it('returns the sapling state diff', async () => {
      ...
      expect(result.root).toEqual(
        '84d1adee98ebdff44b9c034c341e4c18674d88930dbaa10999462c22190c5a4c'
      );
      expect(result.commitments_and_ciphertexts.length).toEqual(5);
      expect(result.commitments_and_ciphertexts[4][0]).toEqual(
        '7be1c4073c6e638fd069179a850fd58bba3a482f12510d940c02194251956801'
      );
      expect(result.commitments_and_ciphertexts[4][1].cv).toEqual(
        '1a450ae8a674fcd9b30cbba409db99af639fc61be879d9d9ce93f782bbb96fc1'
      );
      expect(result.commitments_and_ciphertexts[4][1].epk).toEqual(
        '06380b0434cb1d134ca7bfa7c96295d9bc16c20d0d190c62de17af039f45bcb4'
      );
      expect(result.commitments_and_ciphertexts[4][1].payload_enc).toEqual(
        'd86b1806da061159d2b40df3080e6234f060aa3417f147f1e9c4a171249bee5c504cd6cc4f52d525343aba2143cb65ca85841b988fca654109a5ba40f35af5d983d6cb93da84b9227f6182155b93dd'
      );
      expect(result.commitments_and_ciphertexts[4][1].nonce_enc).toEqual(
        '3147f1fb1dc4b56b4266c708dade7997d3b8e9603bcdf383'
      );
      expect(result.commitments_and_ciphertexts[4][1].payload_out).toEqual(
        '7c3fcd3898f3af11a3cf5bb425040c31217750d4bc1f453463e2e951a96de24b89c819c44a147a2a0bd9457659d0322b5129ab571577105bf9b0ae482ffd7845a8328f89a81f1f5500957a9a6eec62ed'
      );
      expect(result.commitments_and_ciphertexts[4][1].nonce_out).toEqual(
        '28a2f90e987c4b0f5ab3f07f6e730210513939a19c82d798'
      );
