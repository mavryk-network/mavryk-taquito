...
import { HttpResponseError, STATUS_CODE } from '@mavrykdynamics/webmavryk-http-utils';
import { BigMapKeyType, MichelsonMap, MichelsonMapKey, Schema } from '@mavrykdynamics/webmavryk-michelson-encoder';
import {
  OpKind,
...
} from '@mavrykdynamics/webmavryk-core';
...
export class RpcContractProvider extends Provider implements ContractProvider, StorageProvider {
  ...
  contractProviderTypeSymbol = Symbol.for('webmavryk-contract-provider-type-symbol');
