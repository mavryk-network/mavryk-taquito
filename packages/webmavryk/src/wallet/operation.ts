...
import { BlockResponse, OperationContentsAndResult, OperationResultStatusEnum } from '@mavrykdynamics/webmavryk-rpc';
...
import { validateOperation, ValidationResult } from '@mavrykdynamics/webmavryk-utils';
import { BlockIdentifier } from '../read-provider/interface';
import { InvalidConfirmationCountError } from '../errors';
import { ConfirmationUndefinedError, ObservableError } from './errors';
import { InvalidOperationHashError } from '@mavrykdynamics/webmavryk-core';
...
export class WalletOperation {
   ...
   * @param context WebMavryk context allowing access to rpc and signer
