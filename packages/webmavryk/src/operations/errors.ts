...
import { ParameterValidationError, RpcError, WebMavrykError } from '@mavrykdynamics/webmavryk-core';
import {
 ...
 */
export class OriginationOperationError extends WebMavrykError {
