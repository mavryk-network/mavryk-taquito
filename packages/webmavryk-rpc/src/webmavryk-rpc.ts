 ...
 * @module @mavrykdynamics/webmavryk-rpc
 */
import {
  HttpBackend,
  HttpRequestOptions,
  HttpResponseError,
  STATUS_CODE,
} from '@mavrykdynamics/webmavryk-http-utils';
...
import { InvalidAddressError, InvalidContractAddressError } from '@mavrykdynamics/webmavryk-core';
...
export class RpcClient implements RpcClientInterface {
   ...
   * A safer solution to pack and sign data would be to use the `packDataBytes` function available in the `@mavrykdynamics/webmavryk-michel-codec` package.
