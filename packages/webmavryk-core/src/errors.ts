...
// ==========================================================================================
// parent error classes for WebMavryk
// ==========================================================================================
/**
 *  @category Error
 *  @description Parent error class all webmavryk errors to extend from
 */
export class WebMavrykError extends Error {}

/**
 *  @category Error
 *  @description Error that indicates invalid user inputs
 */
export class ParameterValidationError extends WebMavrykError {}

/**
 *  @category Error
 *  @description Error returned by RPC node
 */
export class RpcError extends WebMavrykError {}

/**
 *  @category Error
 *  @description Error that indicates MavrykToolKit has not been configured appropriately
 */
export class MavrykToolkitConfigError extends WebMavrykError {}

/**
 *  @category Error
 *  @description Error that indicates a requested action is not supported by WebMavryk
 */
export class UnsupportedActionError extends WebMavrykError {}

/**
 *  @category Error
 *  @description Error during a network operation
 */
export class NetworkError extends WebMavrykError {}

/**
 *  @category Error
 *  @description Error that indicates user attempts an action without necessary permissions
 */
export class PermissionDeniedError extends WebMavrykError {}

// ==========================================================================================
// common error classes for WebMavryk
// ==========================================================================================
/**
 *  @category Error
 ...
 */
export class PublicKeyNotFoundError extends WebMavrykError {
  constructor(
