...
import { Expr, GlobalConstantHashAndValue, Parser, Prim, ProtocolID } from '@mavrykdynamics/taquito-michel-codec';
...
import { MichelsonV1Expression, MichelsonV1ExpressionBase } from '@mavrykdynamics/taquito-rpc';
