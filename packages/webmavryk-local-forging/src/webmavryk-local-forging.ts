 ...
 * @module @mavrykdynamics/webmavryk-local-forging
 */
...
import { validateBlock, ValidationResult, invalidDetail } from '@mavrykdynamics/webmavryk-utils';
...
import { InvalidBlockHashError, InvalidOperationKindError } from '@mavrykdynamics/webmavryk-core';
...
const PROTOCOL_CURRENT = ProtocolsHash.PtBoreas;
