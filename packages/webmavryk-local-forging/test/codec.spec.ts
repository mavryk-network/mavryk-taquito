...
import { InvalidHexStringError, InvalidPublicKeyError, InvalidKeyHashError } from '@mavrykdynamics/webmavryk-core';
...
describe('Tests for Entrypoint functions and for encode and decoder error messages', () => {
  ...
  test(`Verify publicKeyHashEncoder`, async () => {
    ...
    try {
      publicKeyHashEncoder('mv5WXYtyDUNL91qfiCJtVUX746QpNv5i5ve5');
    } catch (e) {
