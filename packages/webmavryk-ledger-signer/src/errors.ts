...
import { ParameterValidationError, WebMavrykError } from '@mavrykdynamics/webmavryk-core';

/**
 *  @category Error
 *  @description Error that indicates an invalid or unparseable ledger response
 */
export class InvalidLedgerResponseError extends WebMavrykError {
 ...
 */
export class PublicKeyRetrievalError extends WebMavrykError {
 ...
 */
export class PublicKeyHashRetrievalError extends WebMavrykError {
  constructor() {
    super();
