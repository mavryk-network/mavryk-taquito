...
import { SaplingDiffResponse, SaplingTransactionCiphertext } from '@mavrykdynamics/taquito-rpc';
...
import { hex2Bytes, num2PaddedHex } from '@mavrykdynamics/taquito-utils';
