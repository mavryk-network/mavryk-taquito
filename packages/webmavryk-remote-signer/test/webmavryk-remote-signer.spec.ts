...
import { PublicKeyNotFoundError } from '@mavrykdynamics/webmavryk-core';
import { RemoteSigner } from '../src/webmavryk-remote-signer';
...
describe('RemoteSigner test', () => {
  ...
  describe('Sign messages', () => {
    ...
    it('Should fail if pkh is invalid', async () => {
      try {
        new RemoteSigner(
