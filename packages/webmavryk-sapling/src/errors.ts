 ...
 */
export class TreeConstructionFailure extends WebMavrykError {
 ...
 */
export class InsufficientBalance extends WebMavrykError {
 ...
 */
export class SaplingTransactionViewerError extends WebMavrykError {
  constructor(public readonly message: string) {
    super();
