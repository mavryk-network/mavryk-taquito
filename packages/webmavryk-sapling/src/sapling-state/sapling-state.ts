...
import { SaplingDiffResponse, SaplingTransactionCiphertext } from '@mavrykdynamics/webmavryk-rpc';
...
import { hex2Bytes, num2PaddedHex } from '@mavrykdynamics/webmavryk-utils';
