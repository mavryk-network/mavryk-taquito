...
import { InvalidMessageError, InvalidPublicKeyError, InvalidSignatureError } from '@mavrykdynamics/webmavryk-core';

describe('utils signature validation tests', () => {
  describe('SECP256K1 curve', () => {
    it('Should succesfully validate signature', () => {
      const message =
    ...
    it('Should succesfully validate signature when signature has generic prefix', () => {
      const message =
        '';
      const pk = 'sppk7c7hkPj47yjYFEHX85q46sFJGw6RBrqoVSHwAJAT4e14KJwzoey';
      const sig =
  ...
  describe('SECP256K1 curve', () => {
    it('Should succesfully validate signature for P256 curve', () => {
      const message =
    ...
    it('Should succesfully validate signature for P256 curve when signature has generic prefix', () => {
      const message =
        '';
      const pk = 'p2pk66tej1sH5x3q6nKJPRQzrwdNLZaEJ7pxJF6PqxFnDtnoLwxASPC';
      const sig =
