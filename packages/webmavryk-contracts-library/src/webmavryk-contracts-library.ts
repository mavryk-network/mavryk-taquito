 ...
 * @module @mavrykdynamics/webmavryk-contracts-library
 */

import { EntrypointsResponse, ScriptedContracts } from '@mavrykdynamics/webmavryk-rpc';
import { Extension, Context } from '@mavrykdynamics/webmavryk';
import { validateAddress, ValidationResult, invalidDetail } from '@mavrykdynamics/webmavryk-utils';
import { InvalidScriptFormatError } from './errors';
import { ReadWrapperContractsLibrary } from './read-provider-wrapper';
import { InvalidAddressError } from '@mavrykdynamics/webmavryk-core';
...
/**
 * @description Allows to specify static data related to contracts (i.e., script and entrypoints) avoiding WebMavryk to fetch them from the network.
 *
 * @example
 * ```
