 ...
 */
export class InvalidMapTypeError extends WebMavrykError {
...
const michelsonMapTypeSymbol = Symbol.for('webmavryk-michelson-map-type-symbol');
 ...
 */
export class MapTypecheckError extends WebMavrykError {
...
export class MichelsonMap<K extends MichelsonMapKey, T> {
  ...
  // Using instanceof was not working for project that had multiple instance of webmavryk dependencies
