...
const schemaTypeSymbol = Symbol.for('webmavryk-schema-type-symbol');
...
export class Schema {
   ...
   * Note: Provide guidance on how to write the storage object for the origination operation with WebMavryk.
   */
