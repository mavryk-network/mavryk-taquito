...
import { InvalidViewParameterError, WebMavrykError } from '@mavrykdynamics/webmavryk-core';
 ...
 */
export class InvalidScriptError extends WebMavrykError {
 ...
 */
export class InvalidRpcResponseError extends WebMavrykError {
 ...
 */
export class InvalidBigMapSchemaError extends WebMavrykError {
 ...
 */
export class InvalidBigMapDiffError extends WebMavrykError {
 ...
 */
export class BigMapEncodingError extends WebMavrykError {
 ...
 */
export class StorageEncodingError extends WebMavrykError {
 ...
 */
export class MissingArgumentError extends WebMavrykError {
