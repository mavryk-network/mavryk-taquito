...
import { MichelsonV1Expression, MichelsonV1ExpressionExtended } from '@mavrykdynamics/webmavryk-rpc';
 ...
 */
export class TokenArgumentValidationError extends WebMavrykError {
 ...
 */
export class TokenComparisonError extends WebMavrykError {
