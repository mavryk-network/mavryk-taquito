...
import { Schema, Token } from '../../src/webmavryk-michelson-encoder';
  ...
  describe('ExtractSchema', () => {
    it('Should extract schema properly', () => {
      ...
      let extractSchema_ResetFields: object = {
        0: { 0: 'nat', 1: 'nat', 2: 'timestamp' },
        1: { 0: 'nat', 1: 'mumav', 2: 'nat', 3: 'timestamp' },
        2: { 0: 'nat', 1: 'timestamp' },
        3: { 0: 'nat', 1: 'mumav', 2: 'timestamp' },
        4: 'nat',
      };
      Token.fieldNumberingStrategy = 'Legacy';
      ...
      extractSchema_ResetFields = {
        option0: { 0: 'nat', 1: 'nat', 2: 'timestamp' },
        option1: { 0: 'nat', 1: 'mumav', 2: 'nat', 3: 'timestamp' },
        option2: { 0: 'nat', 1: 'timestamp' },
        option3: { 0: 'nat', 1: 'mumav', 2: 'timestamp' },
        option4: 'nat',
      };
      Token.fieldNumberingStrategy = 'Legacy';
